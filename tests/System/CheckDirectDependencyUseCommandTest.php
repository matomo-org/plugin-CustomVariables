    ...
    public function testCommand()
    {
        ...
        $this->assertEquals([
            'Symfony\Component\Console' => [
                'CustomVariables/tests/Commands/InfoTest.php',
                'CustomVariables/tests/Commands/SetNumberOfCustomVariablesTest.php',
                'CustomVariables/tests/System/CheckDirectDependencyUseCommandTest.php'
            ],
